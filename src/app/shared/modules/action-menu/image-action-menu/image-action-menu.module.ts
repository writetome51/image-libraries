...
import { ActionMenuButtonModule }
	from '@app/shared/modules/action-menu/action-menu-button/action-menu-button.module';
import { ActionMenuChoicesModule }
	from '@app/shared/modules/action-menu/action-menu-choices/action-menu-choices.module';
import { ImageActionMenuChoicesManagerService }
	from '@app/shared/modules/action-menu/image-action-menu/image-action-menu-choices-manager.service';
