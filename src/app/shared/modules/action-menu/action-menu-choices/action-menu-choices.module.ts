...
import { DeleteSelectedImagesProcessorService }
	from '@app/shared/modules/action-menu/action-menu-choices/menu-choice/menu-choice-processor/delete-selected-images-processor/delete-selected-images-processor.service';
import { DeleteSelectedImagesResultInterpreterService }
	from '@app/shared/modules/action-menu/action-menu-choices/menu-choice/menu-choice-processor/delete-selected-images-processor/delete-selected-images-result-interpreter.service';
...
import { RunTasksAfterDeletingImagesService }
	from '@app/shared/modules/action-menu/action-menu-choices/menu-choice/menu-choice-processor/delete-selected-images-processor/run-tasks-after-deleting-images.service';
