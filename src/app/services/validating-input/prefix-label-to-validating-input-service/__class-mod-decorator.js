...
exports.__classModDecorator = get_class_modification_decorator_1.getClassModificationDecorator(function (instance, decoratorArgs) {
    var _a = decoratorArgs[0], prefix = _a.prefix, prefix_propertyToBind = _a.prefix_propertyToBind;
    ...
    if (prefix_propertyToBind) {
        if (instance.data.propertyToBind) {
            ...
            instance.data.propertyToBind = prefix;
    }
    ...
    if (is_array_not_array_1.isArray(instance.data.errorMessage)) {
        ...
        instance.data.errorMessage = "The " + prefix + " " + instance.data.errorMessage.slice(4);
});
