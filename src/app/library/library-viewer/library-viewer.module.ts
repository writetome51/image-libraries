...
import { LibraryViewerComponent } from '@app/library/library-viewer/library-viewer.component';
...
import { ImageListModule } from '@app/library/library-viewer/image-list/image-list.module';
